...
| `POST /v2/communities/{communityId}/resubmit`              | Write headers; no payload                                                                                                 | Community resource with `application.status: pending`                                                                                                                                  | `implemented` | `implemented` (Decision 0072); owner-only `rejected -> pending`, clears the reason and review time, audited as `community_resubmitted`; any other state is `409 DATA_STALE`                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
the only path that sets `rejected` (Decision 0072; a verified community is refused).
