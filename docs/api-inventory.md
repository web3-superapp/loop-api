...
| `GET /v2/voice-rooms/{voiceRoomId}`                     | Bearer + contract/client headers                | Room, viewer role, viewer hand raise, `joinedCount` incl. host                            | `implemented` | `implemented`; non-members are `PERMISSION_DENIED`                                                               |
